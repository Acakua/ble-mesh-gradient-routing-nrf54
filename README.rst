...
* **SENSOR_SEND_INTERVAL_MS**: Tần suất gửi tin của các Sensor Node (ví dụ: 5000ms). 
  
  **Lưu ý:** Các em có thể tăng tần suất lên 30 phút hoặc 1 tiếng tùy vào kết quả sau khi đã test xong, anh nghĩ nên đặt 30 phút trước sau đó phân tích kết quả rồi mới set tiếp.

* **Địa chỉ Sink:** Khi Flash code và provision cho các node thì sink node phải có địa chỉ là 0x0002.
* **Cổng UART:** Nhớ đảm bảo cổng UART không bị chiếm dụng bởi ứng dụng nào khác như nRF Connect for Desktop.
...
Bước 4: Lấy kết quả
~~~~~~~~~~~~~~~~~~~
* Sau khi chạy hãy đợi 5 - 10 phút để dữ liệu được đẩy hết qua UART và lưu vào log.
...
* Hãy lưu lại file log FINAL sau mỗi lần chạy xong hoặc có thể gửi qua cho anh luôn để anh phân tích trước.
